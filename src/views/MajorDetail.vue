      ...
      <v-tabs grow>
        ...
        <v-tab-item value="1">
          ...
          <v-list two-line class="mt-2">
            <v-list-item v-for="item in listData" :key="item.id" class="mb-2">
              <v-card width="100%" class="d-flex align-center pd-2 pt-2 pl-2">
                <div class="mr-4" style="width: 30%">
                  <v-list-item-avatar color="secondary" class="mr-2 mb-2" size="60">
...
export default class extends Vue {
    ...
    private onAreaChange(res: AreaTree[]) {
